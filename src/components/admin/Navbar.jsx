    ...
    <nav className="bg-gray-800 sm:hidden">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div onClick={()=> router.push('/raithan-add')} className="flex flex-shrink-0 items-center cursor-pointer">
              <img
                ...
                <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  {
                    ...
                    {({ active }) => (
                      ...
                      >
                        <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6 mr-2">{i.icon}</svg>
                        {i.name}
                      </Link>
                    )}
                  </Menu.Item>
